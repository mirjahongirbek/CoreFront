    ...
    <d-card-body class="d-flex flex-column">
      <div class="quick-post-form">
        ...
        <div class="form-group" v-if="!projectName">
          <d-form-select class="form-control" v-model="models.projectName" :options="options" />
        </div>
        ...
        <div class="form-group">
          <d-input class="form-control" v-model="models.statusCode" placeholder="status Code" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <textarea v-model="models.errorResult.message" :disabled="!enabled" class="form-control"></textarea>
        </div>
        <div class="form-group">
...
export default {
  ...
  methods: {
    addResult() {
      if (!this.update)
        this.$api
          .post("/home/AddMyModel", this.models)
          .then(
            response => {},
